...
const Test1Intro3: React.FC = () => {
  ...
  const handleContinue = () => {
    dispatch(setCurrentPage('test1/task3'));
    navigate('/test1/task3');
  };
  ...
  return (
    <TestIntroContainer>
      ...
      <Description>{taskIntroInstructions.task3}</Description>
